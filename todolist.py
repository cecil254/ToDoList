...
# Heading Label
Label(root, text='Simple To Do List', bg='PaleVioletRed', font=("Comic Sans MS", 15), wraplength=300).place(x=35, y=0)

# List of tasks with a Scrollbar
tasks = Listbox(root, selectbackground='Coral', bg='Teal', font=('Helvetica', 12), height=12, width=25)
...
# Entry widget where the user can enter a new item
